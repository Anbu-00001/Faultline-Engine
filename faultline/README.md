...
> 4. **Convince yourself it's real** → [why it's a *new* Orbit capability (3-hop cap, proven live)](#why-this-is-a-new-capability-for-orbit) · [why every number is correct](CORRECTNESS.md) · [caught **21 of 32** real BugsInPy regressions](empirical/RESULTS.md).
